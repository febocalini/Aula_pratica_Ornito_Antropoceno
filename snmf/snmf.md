...
## Descrição
Este script executa análises de **sNMF** a partir de dados de SNPs no formato VCF, incluindo conversões de formato, teste de múltiplos valores de alpha e visualização dos resultados.
